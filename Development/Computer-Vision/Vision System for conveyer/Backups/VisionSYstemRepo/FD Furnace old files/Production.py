...
#conn = pyodbc.connect('DRIVER={SQL Server};SERVER=INCHN08DB05\SQLHOTEL;DATABASE=IN_Digitalization;UID=Ignition;PWD=NA4x3CQIdkkKSkE3n')
#cursor = conn.cursor()
...
############### Track Function 
    ...
    def realtime_capture(self):
        ...
        global detector,params,brightnessThreshold,flag,stopExecution,recordStatus,recordFlag
    ...
    #    gray=cv2.morphologyEx(gray,cv2.MORPH_CLOSE,kernel)
        ...
        while True:
            ...
            if minute==51 and second>50 and flag==0:
    ...
    def retranslateUi(self, FurnaceVisionSystem):
        ...
        self.radioButton_2.setText(_translate("FurnaceVisionSystem", "Record"))
        self.radioButton.setText(_translate("FurnaceVisionSystem", "Disable"))
