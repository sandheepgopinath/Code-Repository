...
# Form implementation generated from reading ui file 'projectUI_Alterrecipe.ui'
#
...
class Ui_FurnaceVisionSystem(object):
    def setupUi(self, FurnaceVisionSystem):
        ...
        self.Set_5 = QtWidgets.QPushButton(self.groupBox_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Set_5.sizePolicy().hasHeightForWidth())
        self.Set_5.setSizePolicy(sizePolicy)
        self.Set_5.setMaximumSize(QtCore.QSize(186, 23))
        self.Set_5.setObjectName("Set_5")
        self.gridLayout_5.addWidget(self.Set_5, 2, 1, 1, 1)
    ...
    def retranslateUi(self, FurnaceVisionSystem):
        ...
        self.Set_5.setText(_translate("FurnaceVisionSystem", "Update Recipe"))
